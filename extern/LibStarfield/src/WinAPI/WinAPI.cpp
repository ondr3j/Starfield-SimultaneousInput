...
namespace WinAPI
{
	...
	{
		return static_cast<std::uint32_t>(::GetEnvironmentVariableA(
	...
	[[nodiscard]] std::uint32_t GetEnvironmentVariable(
		...
		std::uint32_t  a_size) noexcept
	{
		return static_cast<std::uint32_t>(::GetEnvironmentVariableW(
	...
	{
		return static_cast<bool>(::GetFileVersionInfoA(
	...
	bool GetFileVersionInfo(
		...
		void*          a_data) noexcept
	{
		return static_cast<bool>(::GetFileVersionInfoW(
	...
	{
		return static_cast<std::uint32_t>(::GetFileVersionInfoSizeA(
			static_cast<::LPCSTR>(a_filename),
	...
	std::uint32_t GetFileVersionInfoSize(
		...
		std::uint32_t* a_handle) noexcept
	{
		return static_cast<std::uint32_t>(::GetFileVersionInfoSizeW(
			static_cast<::LPCWSTR>(a_filename),
			reinterpret_cast<::LPDWORD>(a_handle)));
	}
	...
	std::uint32_t GetModuleFileName(
		...
		std::uint32_t a_size) noexcept
	{
		return static_cast<std::uint32_t>(::GetModuleFileNameA(
	...
	std::uint32_t GetModuleFileName(
		...
		std::uint32_t a_size) noexcept
	{
		return static_cast<std::uint32_t>(::GetModuleFileNameW(
			static_cast<::HMODULE>(a_module),
	...
	void* GetModuleHandle(const char* a_moduleName) noexcept
	{
		return static_cast<void*>(
			::GetModuleHandleA(static_cast<::LPCSTR>(a_moduleName)));
	}

	void* GetModuleHandle(const wchar_t* a_moduleName) noexcept
	{
		return static_cast<void*>(
			::GetModuleHandleW(static_cast<::LPCWSTR>(a_moduleName)));
	}
	...
	{
		return static_cast<std::int32_t>(::MessageBoxA(
	...
	std::int32_t MessageBox(
		...
		unsigned int   a_type) noexcept
	{
		return static_cast<std::int32_t>(::MessageBoxW(
			static_cast<::HWND>(a_wnd),
	...
	{
		return static_cast<bool>(::TlsSetValue(
	...
	{
		return static_cast<bool>(::VirtualFree(
	...
	{
		return static_cast<bool>(::VerQueryValueA(
	...
	bool VerQueryValue(
		...
		unsigned int*  a_len) noexcept
	{
		return static_cast<bool>(::VerQueryValueW(
			static_cast<::LPCVOID>(a_block),
	...
	{
		return static_cast<bool>(::VirtualProtect(
			static_cast<::LPVOID>(a_address),
			static_cast<::SIZE_T>(a_size),
